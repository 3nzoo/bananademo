...
export const optionsHem = [
  { label: "All Sides", value: "All Sides" },
  { label: "no Hem", value: "no Hem" }
];

export const optionsTurnaround = [
  { label: "Next Day", value: "Next Day" },
  { label: "Same Day", value: "Same Day" }
];

export const optionsSlides = [
  { label: "1", value: "1" },
  { label: "2", value: "2" }
];
...
// Options for meshBanner

// Options for SuperSmooth
